...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(DataCenterProvider.class);

    private final DataCenter dataCenter;

    public DataCenterProvider(String dataCenterAsString)
    {
        ...
        if (replacement != null)
        {
            ...
            this.dataCenter = replacement;
        }
        else
        {
            this.dataCenter = DataCenter.fromString(dataCenterAsString);
        }
    }
