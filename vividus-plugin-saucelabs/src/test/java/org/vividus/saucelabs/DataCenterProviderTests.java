...
{
    private final TestLogger testLogger = TestLoggerFactory.getTestLogger(DataCenterProvider.class);
    ...
    {
        var dataCenterProvider = new DataCenterProvider(dataCenterAsString);
        assertEquals(dataCenterProvider.getDataCenter(), expected);
